...
URL = "C:\\Users\\Miriam\\Documents\\Masters Research\\DataScience\\companyRedirects.csv"
...
words=clean_data(df[1]) #first column is training data, all other data test
...
def build_dataset(words):
  ...
  for k, c in dropwhile(lambda key_count: key_count[1] < 3, temp.most_common()):
      del temp[k]
  count.extend(temp.most_common())
  del temp
...
del words, df  # Hint to reduce memory.
